...
const education = document.getElementById('sducation')
...
const Item = document.querySelectorAll('.menu__list')
const sections = document.querySelectorAll("main > section")
const changtheme = document.querySelector('.change-theme')
...
resumelistItems.forEach(resumeListItem => {
    resumeListItem.addEventListener('click', function (){
        ...
        document.querySelector('.resume-content__show').classList.remove('resume-content__show')
        this.classList.add('resume-list__item--active')
        let atriute= this.getAttribute('data-content-id')
        document.querySelector(atriute).classList.add('resume-content__show')
    })
})
...
portfolioListItems.forEach(portfolioListItem => {
    portfolioListItem.addEventListener('click', function (){
        ...
        document.querySelector('.portfolio-content__show').classList.remove('portfolio-content__show')
        this.classList.add('portfolio-list__item--active')
        let contentId = this.getAttribute('data-content-id')
        document.querySelector(contentId).classList.add('portfolio-content__show')
    })
})
...
function observerHandler(allSections) {
    allSections.map(section => {
        ...
        let sectionMenuItem = document.querySelector(`.menu__list[data-section=${sectionClassName}]`)
 ...
 /// Dark -light theme
changtheme.addEventListener('click' , function(){
